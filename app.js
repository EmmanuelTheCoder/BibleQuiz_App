...
function showScores(){
    ...
    gameOverHtml += "<h2 id='score'> Your score: " + quiz.score + " out of " + 20 + "</h2>" + "<button class='restart' onclick='origin()'> Restart </button>" + "<p class='mailme'>loyaltysamuel001@gmail.com</p>";
